      ...
      child: Column(
        ...
        children: [
          Text(
            ...
            style: TextStyle(color: Colors.white.withValues(alpha: 0.85), fontWeight: FontWeight.w600, fontSize: 13.5),
          ),
          ...
          Text(
            ...
            '(короткий номер — 124)',
            style: TextStyle(color: Colors.white.withValues(alpha: 0.6), fontSize: 12.5, height: 1.6),
          ),
        ],
      ),
    );
